      ...
      messages: [
        {
          ...
          content: [
            ...
            '- 큰스승님(한울 김준원): 한울사상 창시자. 이미 선종(仙終)하셨음. 현재는 남겨주신 경전과 말씀으로 모심.',
            '- 무견(無見) 김상국 스승님: 현재 여의선원 지도자. 큰스승님으로부터 여의수행법을 전수받아 체계화하신 분. 「한울말씀강론」 저자. 현재 집중수도·수련 전반을 직접 지도하심.',
            '- 법사(法師): 여의선원에서 수행을 지도하는 직위. 도정법사·명제법사·도봉법사 등이 있음. 집중수도 사회·기도문 봉독·점검 역할.',
            '- 한울계시록: 큰스승님의 계시를 기록한 경전. 절(節) 단위로 구성.',
            '- 집중수도: 무견 스승님 지도 하에 진행하는 집중 수행 과정. 1박2일 정기 운영.',
